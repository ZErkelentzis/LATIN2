...
thf(conj, conjecture, 
(! [V_s:t_set]: (((set_rel @ V_s) @ V_s) => (! [V_t:t_set]: (((set_rel @ V_t) @ V_t) => (! [V_u:t_set]: (((set_rel @ V_u) @ V_u) => (! [V_v:t_set]: (((set_rel @ V_v) @ V_v) =>
...
(! [V_h:t_set > t_set]: ( ( (! [V_x:t_set]: (((t_in @ V_x) @ V_u) => ((set_rel @ (V_h @ V_x)) @ (V_h @ V_x)))) & (! [V_x:t_set]: (((t_in @ V_x) @ V_u) => ((t_in @ (V_h @ V_x)) @ V_v))) ) =>
(! [V_x:t_set]: (((set_rel @ V_u) @ V_u) => (((t_in @ V_x) @ V_s) => 
( (set_rel @ (V_h @ (V_g @ (V_f @ V_x)))) @ (V_h @ (V_g @ (V_f @ V_x))) ) 
))))))))))))))))
)).
