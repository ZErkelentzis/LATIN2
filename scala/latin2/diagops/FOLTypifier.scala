...
import info.kwarc.mmt.moduleexpressions.operators.typeops.LATIN2Environment
...
/**
  ...
  */
object ComputeFOLTypified extends
  FunctorialLinearDiagramOperator[ComputeFOLTypifiedHelperContext](LogicDiagramOperatorsSyntax.fol_typifier) {
