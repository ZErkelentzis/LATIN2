// Auto-generated file for theory latin:/?Types
package lf
...
/** Convenience functions for the MMT URIs of the declarations in the theory latin:/?Types
    along with apply/unapply methods for them */
object Types extends TheoryScala {
  val _base = DPath(utils.URI(Some("latin"), None, abs=true))
  val _name = LocalName("Types")
  
  object tp extends ConstantScala {
